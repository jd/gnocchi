...
running the tests suites. They are different scenarios being run: `PEP 8`_
compliance tests, ugrade tests, unit and functional tests.
...
The `Gnocchi's Pastamaker dashboard`_ shows the current status of the merge
queue.
