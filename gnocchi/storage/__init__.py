...
class StorageDriver(object):
    ...
    def _store_timeserie_splits(self, metric, keys_and_aggregations_and_splits,
        ...
        for (key, aggregation), split in six.iteritems(
            ...
            if split is None:
                ...
                LOG.warning("No data found for metric %s "
                            "(aggregation method %s, split key %s): "
                            "possible data corruption",
                            metric, aggregation.method, key)
                continue
    ...
    def _add_measures(self, metric, aggregations_and_timeseries,
                ...
                if need_rewrite:
                    for key in existing_keys:
                        if previous_oldest_mutable_key <= key:
                            ...
                            # pass None as split.
                            keys_and_split_to_store[(key, aggregation)] = None
    ...
    def compute_and_store_timeseries(self, metric, measures):
        ...
        def _map_add_measures(bound_timeserie):
            ...
            self._add_measures(metric, aggregations_and_timeseries,
