...
def list_opts():
    return [
        ...
        ("metricd", (
            ...
            cfg.BoolOpt(
                'respect_processing_delay', default=False,
                help="Force `metric_processing_delay` to be respected even if "
                "metricd is notified that measures are ready to be processed."
            ),
